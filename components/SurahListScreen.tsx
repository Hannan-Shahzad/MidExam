...
//           contentContainerStyle={styles.listContentContainer} // Added to ensure scrolling
//         />
//       )}
//     </View>
//   );
...
//   },bannerContainer: {
//     backgroundColor: '#8b008b', // Dark purple background for the banner
//     flexDirection: 'row', // To position text and image side by side
//     justifyContent: 'space-between', // Ensures spacing between text and image
//     paddingVertical: 20, // Adjust height of the banner
//     paddingHorizontal: 10,
//     alignItems: 'center',
//     borderRadius: 10, // Rounded corners for the banner
//     marginBottom: 20,
//     height: 160, // Set the height of the banner container
//   },
//   bannerText: {
...
//     height: 80, // Set image height to cover half of the banner
//     resizeMode: 'contain', // Ensures image fits within the container
//   },
//   listContentContainer: {
//     paddingBottom: 20, // Ensures there’s enough space to scroll down
//   },
//   surahContainer: {
//     padding: 15,
//     borderBottomWidth: 1,
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.bannerContainer}>
        ...
        <Image
          style={styles.bannerImage}
          source={{ uri: 'data:image/jpeg;base64,...' }} // Keep your base64 string here
        />
      </View>
...
const styles = StyleSheet.create({
  ...
  bannerText: { fontSize: 24, fontWeight: 'bold' },
  bannerImage: { width: '100%', height: 150, marginBottom: 10 },
  surahContainer: { padding: 10, borderBottomWidth: 1, borderColor: '#ccc' },
  surahName: { fontSize: 18 },
  surahDetailsContainer: { padding: 10, backgroundColor: '#f9f9f9' },
  ayahText: { fontSize: 16 },
});
